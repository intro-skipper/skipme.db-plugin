...
/// </summary>
public class SyncSegmentsTask : IScheduledTask, IConfigurableScheduledTask
{
    ...
    /// <param name="taskManager">The Jellyfin task manager used to trigger media segment extraction.</param>
